workdir = '/kaggle/working/model/model110'
seed = 40
apex = True
...
data = dict(
    train=dict(
        ...
        imgdir='/kaggle/input/rsna-intracranial-hemorrhage-detection/rsna-intracranial-hemorrhage-detection/stage_2_train',
        imgsize=imgsize,
        n_grad_acc=1,
        loader=dict(
            shuffle=True,
    ...
    test = dict(
        ...
        imgdir='/kaggle/input/rsna-intracranial-hemorrhage-detection/rsna-intracranial-hemorrhage-detection/stage_2_test',
        imgsize=imgsize,
        loader=dict(
            shuffle=False,
            batch_size=batch_size,
